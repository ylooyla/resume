...
const Skills = [
	{
		title: '原生语言',
		children: [
			'熟悉 Html5 和 Css3 ，对 HTML 语义化有深刻认识，像素级还原设计稿的能力；',
			'熟悉 Canvas / Svg / Audio / Video 等Html5新特性的使用；',
			'熟悉 JavaScript / TypeScript 语言，熟悉 ES6+ 语法、异步流程控制 、 Promise 、 Async 等异步操作；',
		],
	},
	{
		title: '计算机基础',
	...
	{
		title: '第三方库',
		children: ['熟悉Bootstrap栅格系统，响应式布局和移动端开发；熟悉 ECharts 数据可视化开发；',
	...
	},
	{
		title: '工程化',
		children: [
			'熟悉 WebPack / Parcel / Gulp 等打包工具，熟悉前端工程化构建流程、Webpack性能优化；',
	...
	},
	{
		title: '框架',
		children: [
			'熟悉 Vue2 / Vue3 全家桶 、 组件化开发 、Vue-Router 路由管理和路由守卫 、 Vuex 状态管理；',
		],
	},
	{
		title: '服务器',
		children: [
			'熟悉 Node.js 、 流 、网络 、文件 、数据驱动和ORM 和 Express框架 的基本使用；',
	...
	},
	{
		title: '测试与工具',
		children: [
			'了解 jest / mocha 前端单元测试、持续集成服务 Travis 相关知识； 熟悉 Git 版本管理工具；',
