    ...
    },
    {
        ...
        content: [
            ...
            },
            {
                title: '工作和成就',
                children: [
                    '1. 负责 登录、注册、分享、自定义弹窗 等公共逻辑的抽离 Hook ，100% 统一H5登录、注册等组件的逻辑复用；',
                    ...
                    '4. 负责 前端日志 SDK 设计、 nodejs 开发日志告警方案，完善 前端日志监控流程，让监控可视化、数据化；提高了错误日志、bug的发现率，减少了公司的损失，获得团队一致好评。'
                ]
            }
        ]
    },
        ...
        content: [
            {
                title: '项目介绍',
                children: [
                    '中国移动Ums运维管理平台，包括监控、告警、CMDB、流程、自动化、运营等6大模块，满足 运维、产品、现场团队的运维和运营等综合需求。'
                ]
            },
            {
                title: '技术栈',
